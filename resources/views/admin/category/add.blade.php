				...
				<div class="panel-body">
					...
					<form class="form-horizontal" method="post" action="{{ url('admin/category') }}">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-9">
						      	<input type="text" value="" class="form-control" name="cate_name" placeholder="请输入分类名称">
						    </div>
						</div>
						<div class="form-group">
						    <label class="col-sm-2 control-label">分类标题</label>
						    <div class="col-sm-9">
						      	<input type="text" value="" class="form-control" name="cate_title" placeholder="请输入分类标题">
						    </div>
						</div>
						<div class="form-group">
						    <label class="col-sm-2 control-label">关键词</label>
						    <div class="col-sm-9">
						      	<input type="text" value="" class="form-control" name="cate_keywords" placeholder="请输入关键词">
						    </div>
						</div>
						<div class="form-group">
						    <label class="col-sm-2 control-label">描述</label>
						    <div class="col-sm-9">
						      	<textarea name="cate_description" class="form-control" rows="4" placeholder="请输入描述"></textarea>
						    </div>
						</div>
						<div class="form-group">
						    <label class="col-sm-2 control-label">排序</label>
						    <div class="col-sm-9">
						      	<input type="text" style="width:100px; display: inline-block;" class="form-control" name="cate_order" placeholder="请输入排序">
